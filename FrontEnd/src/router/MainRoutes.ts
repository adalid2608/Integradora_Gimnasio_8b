const MainRoutes = {
    ...
    children: [
        ...
        {
            path: '/dashboards/nutricion/evaluacion-nutricional',
            component: () => import('@/views/dashboards/nutricion/evaluacion/Evaluacion.vue'),
        },
        {
            path: '/dashboards/nutricion/dietas',
            component: () => import('@/views/dashboards/nutricion/dietas/Dietas.vue'),
        },
        {
